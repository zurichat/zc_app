...
class ThreadCardShared extends ViewModelWidget<ThreadCardViewModel> {
  ThreadCardShared(this.userPost, {Key? key}) : super(key: key);
                        ...
                        children: [
                          const SizedBox(
                            ...
                            child: VerticalDivider(
                                color: AppColors.dividerColor, thickness: 5),
                          ),
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Row(
                                  children: [
                                    Image.asset(userPost.sharedUserDisplayImage!,
                                        height: 20, width: 20),
                                    UIHelper.customHorizontalSpace(10),
                                    Text(userPost.userSharedFrom!,
                                        style: AppTextStyle.darkGreySize14),
                                  ],
                                ),
                                UIHelper.customVerticalSpace(10),
                                Text(userPost.sharedMessage!,
                                    style: AppTextStyle.darkGreySize14
                                ...
                                Text(
                                    ...
                                    maxLines: 3,
                                    style: AppTextStyle.lightGreySize12.copyWith(
