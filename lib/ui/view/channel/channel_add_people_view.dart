...
class ChannelAddPeopleView extends StatelessWidget {
	...
	@override
	Widget build(BuildContext context) => ViewModelBuilder<ChannelAddPeopleViewModel>.reactive(
		viewModelBuilder: () => ChannelAddPeopleViewModel(),
		builder: (context, viewModel, child) => Scaffold(
			appBar: AppBar(
				title: "Add People".text.textStyle(GoogleFonts.lato()).color(Color(0xFF242424)).bold.size(20.0).make(),
				...
				actions: [
					InkWell(
						child: "Add".text.textStyle(GoogleFonts.lato()).color(Color(0xFF00B87C)).size(16.0).make(),
					...
					Row(
						...
						children: [
							Column(
								...
								children: [
									"Add Everyone".text.bold.textStyle(GoogleFonts.lato()).color(Color(0xFF242424)).make(),
									4.heightBox,
									"Everyone will be added to this channel".text.textStyle(GoogleFonts.lato()).color(Color(0xFF999999)).size(12.0).make(),
								],
							),
							Checkbox(
								...
								Row(
									children: [
										Stack(
											...
											children: [
												Image.asset("assets/images/${viewModel.matchingUsers[index].userimg}").p(4.0),
												if (viewModel.matchingUsers[index].online) CircleAvatar(
										...
										20.widthBox,
										viewModel.matchingUsers[index].userName.text.textStyle(GoogleFonts.lato()).color(Color(0xFF424141)).make(),
									],
								).expand(),
								Checkbox(
									value: viewModel.markedUsers.contains(viewModel.matchingUsers[index]),
