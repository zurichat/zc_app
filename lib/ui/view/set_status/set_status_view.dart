                            ...
                            Column(
                              children: [
                                CustomListTile(
                                  leading: Image.asset('assets/four.png'),
                                  title:
                                      Text('- Don\'t clear', style: titleStyle),
                                ),
                                CustomListTile(
                            ...
                            Column(
                              children: [
                                CustomListTile(
                                  ...
                                  title: Text('In a meeting - 1 hour',
                                      style: titleStyle),
                                ),
                                CustomListTile(
                                  leading: Image.asset('assets/car.png'),
                                  title: Text('Commuting - 30 minutes',
                                      style: titleStyle),
                                ),
                                CustomListTile(
                                  leading: Image.asset('assets/sick.png'),
                                  title: Text('Out sick - Today',
                                      style: titleStyle),
                                ),
                                CustomListTile(
                                  leading: Image.asset('assets/vacation.png'),
                                  title: Text('Vacationing - Don\'t clear',
                                      style: titleStyle),
                                ),
                              ],
                            )
